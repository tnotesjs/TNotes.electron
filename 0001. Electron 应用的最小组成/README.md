...
- [3. 🔗 links](#3--links)
- [4. 📒 electron 应用的最小组成](#4--electron-应用的最小组成)
- [5. 📒 最终效果展示](#5--最终效果展示)
- [6. 💻 demo - 实现步骤](#6--demo---实现步骤)
  - [6.1. 安装 Node.js 和 npm](#61-安装-nodejs-和-npm)
  - [6.2. 安装 Electron](#62-安装-electron)
  - [6.3. 准备入口文件（主进程）](#63-准备入口文件主进程)
  - [6.4. 准备页面（渲染进程，非必需）](#64-准备页面渲染进程非必需)
  - [6.5. 配置启动命令（非必需）](#65-配置启动命令非必需)
  - [6.6. 启动 Electron 应用](#66-启动-electron-应用)
- [7. 🤔 问：主进程加载的入口文件是？](#7--问主进程加载的入口文件是)
<!-- endregion:toc -->
## 1. 📝 summary
