---
id: 066a2e22-772a-4740-8fec-3124051e5b58
---
...
- 注册环节基本流程：
  - ![](../assets/0034-2024-10-05-22-21-01.png)
- 触发环节基本流程：
  - ![](../assets/0034-2024-10-05-22-21-12.png)
...
- ![](../assets/0034-2024-10-05-22-23-39.png)
- 点击【窗口 1】的按钮，所有窗口的 `<h1>` 的内容都变为 1。
- ![](../assets/0034-2024-10-05-22-23-54.png)
- 点击【窗口 2】的按钮，所有窗口的 `<h1>` 的内容都变为 2。
- ![](../assets/0034-2024-10-05-22-24-07.png)
- 点击【窗口 3】的按钮，所有窗口的 `<h1>` 的内容都变为 3。
- ![](../assets/0034-2024-10-05-22-24-22.png)
